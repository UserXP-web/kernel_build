...
if [ -d ../../out/arch/arm64/boot/dts/qcom ] ; then
  ...
  echo NOT found ../../out/arch/arm64/boot/dts/qcom
  if [ -d ../../out/arch/arm64/boot/dts ] ; then
    echo found ../../out/arch/arm64/boot/dts
  else
    echo NOT found ../../out/arch/arm64/boot/dts
    if [ -d ../../out/arch/arm64/boot ] ; then
      echo found ../../out/arch/arm64/boot
    else
      echo NOT found ../../out/arch/arm64/boot
    fi
  fi
fi
exit
